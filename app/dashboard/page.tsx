    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-gray-200 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center gap-8">
          <span className="font-bold text-lg text-gray-900">💰 FinanceApp</span>
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <button
              className="text-xs border border-gray-200 rounded-lg px-3 py-1.5 text-gray-600 hover:bg-red-50 hover:border-red-200 hover:text-red-600 transition-colors"
              onClick={() => {
                localStorage.clear();
